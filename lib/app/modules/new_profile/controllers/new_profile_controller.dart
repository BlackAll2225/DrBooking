...
class NewProfileController extends BaseController {
  //TODO: Implement NewProfileController
  ...
  TextEditingController bhtyAddressTextController = TextEditingController(text: '');
  TextEditingController cccdTextController = TextEditingController(text: '');
  TextEditingController cccdDateTextController = TextEditingController(text: '');
  TextEditingController cccdAddressTextController = TextEditingController(text: '');
     ...
     await Get.defaultDialog(
        ...
        content: SizedBox(
          ...
          child: CalendarDatePicker2(
            ...
            onValueChanged: (value) async {
             bhytExpTextController.text =  UtilCommon.convertDateTime(value[0]!);
     ...
     await Get.defaultDialog(
        ...
        content: SizedBox(
          ...
          child: CalendarDatePicker2(
            ...
            onValueChanged: (value) async {
             cccdDateTextController.text =  UtilCommon.convertDateTime(value[0]!);
