          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBoxConst.size(context: context),
                Obx(() => Visibility(
                    visible: controller.selectedMedicalService.value.id != null,
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      mainAxisSize: MainAxisSize.min,
                      children: [
      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            children: [
              TextConstant.subTile1(context,
                  text: '${controller.requestParamBooking.patient?.fullname}',
                  fontWeight: FontWeight.bold),
              SizedBoxConst.size(context: context),
              TextConstant.subTile2(context,
                  text: UtilCommon.convertDateTime(
                      controller.requestParamBooking.patient!.dateOfBirth!),
                  color: Colors.grey,
                  fontWeight: FontWeight.bold)
            ],
          ))
