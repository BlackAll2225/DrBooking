...
class ForgotPasswordView extends BaseView<ForgotPasswordController> {
  ...
  return Scaffold(
        ...
        body: SafeArea(
          child: Column(
            children: [
              AppBarCustom(callback: (){Get.back();}, title: 'Quên mật khẩu'),
              Expanded(
                child: Material(
                  child: Container(
                    color: Colors.white,
                        ...
                        children: [
                          ...
                          ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  backgroundColor:controller.isEnableButton.value? ColorsManager.primary:Colors.grey,
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: GoogleFonts.montserrat(
                                        color: controller.isEnableButton.value? Colors.white:Colors.black,
                                        fontSize:
                                            UtilsReponsive.formatFontSize(13, context),
