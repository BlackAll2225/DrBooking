...
import 'package:drbooking/app/modules/personal-information/controllers/personal_information_controller.dart';
...
class VerifyOtpPhoneChangeView extends BaseView<PersonalInformationController> {
  const VerifyOtpPhoneChangeView({Key? key}) : super(key: key);
  @override
          ...
          children: [
            ...
            OtpTextField(
              ...
              onSubmit: (String verificationCode) async {
                await controller.changePhone(verificationCode);
              }, // end onSubmit
            ),
            SizedBox(
            ...
            Obx(
              () => ConstrainedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                 await   controller.changePhone(controller.otp.value);
